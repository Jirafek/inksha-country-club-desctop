...
const BirthGuest = () => {
   ...
   return (
      <div className={`  relative pt-[5vh] pb-[5vh] bg-BirthLightPurple max-h-[1000px] text-white md:pb-[25vh]`}>
               ...
               {guests.map((guest, i) => {
                  return (
                     <SwiperSlide className="px-[2vw] flex justify-center items-center  md:p-0" key={i}>
                        ...
                        <div className="flex mb-10 w-full mx-auto bg-gray-200 rounded-[10px  max-w-[1050px] items-center justify-end">
