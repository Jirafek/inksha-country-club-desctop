   ...
   return (
      <div name='proga' id='program' className='relative bg-RusLigthBlue py-[120px] '>
         ...
         {/* <div className='md:grid hidden  max-w-[1400px] mx-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-content-start place-items-start md:px-[30px] gap-[40px] w-full'>
            ...
            {selectedimages.map((item, i) => {
               return (
                  ...
                  <div key={i} className={` ${s.acariMedium} w-[94%] sm:max-w-[500.43px]  bg-white rounded-[10px] border border-RusLigthBlue`}>
                        ...
                        <div className='flex flex-col items-center justify-center gap-4 md:flex-row md:gap-0 md:justify-between'>
                           ...
                           {item.hasAbout ?
                              <div onClick={() => { handleProductClick(item.number) }} className="cursor-pointer w-[156.94px] h-[41.64px] rounded-[20px] flex justify-center items-center ">
                                 <div className="text-center text-RusRed border-RusRed border-2 px-4 py-1 rounded-[20px] font-semibold">Подробнее</div>
                              </div>
                              :
               ...
               {selectedimages.map((item, i) => {
                  return (
                     <SwiperSlide className="py-[30px]" key={i}>
                        ...
                        <div key={i} className={` ${s.acariMedium} w-full  bg-white rounded-[10px] border border-Rustext-RusLihborder-RusLigthBlue`}>
         ...
         <a className='mx-auto' href='#module'>
            <Button className='bg-RusDarkRed md:w-[600px] w-[70%] text-md+ h-[40px] md:h-[70px] text-white mx-auto'>Посмотреть локации</Button>
         </a>
