...
const questionData = [
    {
        ...
        answer: 'Выберите дату и кол-во гостей, локацию, введите свои имя и телефон, перейдите на страницу оплаты, введите данные карты. Как только мы получим оплату, вам на почту прийдет письмо с подтверждением бронирования. С вами свяжется менеджер.',
    },
    {
        title: 'КАК ПРОЕХАТЬ?',
    ...
    {
        title: 'ПРЕДОСТАВЛЯЕТЕ ЛИ ВЫ ПРЕНАДЛЕЖНОСТИ ДЛЯ BBQ?',
        answer: 'Да! В бронирование входит мешок угля (2.5кг), розжиг (150мл), решетка и шампура (4шт)',
    },
    {
        title: 'МОЖНО ЛИ ПЕРЕНЕСТИ БРОНЬ?',
        answer: 'Юронь можно переносить за 24 часа до заезда. Переносить бронь можно только 1 раз.',
    },
    {
    ...
    },
    {
        ...
        answer: 'Мы любим животных. Не забудьте нас предупредить по породе вашего хвостатого при бронировании.',
    },
    {
    ...
    },
    {
        ...
        answer: 'Мы проводим все виды мероприятий (кроме поминок), если какое-то мероприятие мы не проводим смотри первый пункт.',
    },
    {
