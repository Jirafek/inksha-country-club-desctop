...
const HousingJoinus = () => {
   return (
      <div className='relative '>
         ...
         <img src={img} className='w-full h-[350px] object-cover' alt="" />
         <div className='py-[60px]'>

            <div className='text-36px mb-[50px] text-brown text-center font-bold'>
            ...
            <div className='flex justify-center gap-[140px] items-center'>
               ...
               <div className='border border-brown flex max-w-[500px] flex-col pr-[90px] rounded-[16px] gap-[30px] p-[20px]'>
                  {socials.map((item, i) => {
                     return (
