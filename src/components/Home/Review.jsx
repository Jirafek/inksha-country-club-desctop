        ...
        <section className="relative min-h-screen w-full bg-[#201E1F]">
            ...
            <m.div
                ...
                <m.div
                    ...
                    {
                        reviewData.map((el, i) => (
                            <div className="flex relative sm:flex-row flex-col items-center lg:gap-14 gap-7 lg:py-7 py-3 lg:px-14 px-4 bg-[#221C1C] border border-[#AB8E67] rounded-[15px] lg:mr-40 mr-4">
                                <div className="absolute left-0 top-0 2xl:block hidden">
                                    <div className="relative flex">
                                        <img src="/image/comma.png" alt="" />
                                        <img className="absolute left-12" src="/image/comma.png" alt="" />
                                    </div>
                                </div>
                                <div className="absolute right-0 -bottom-12 lg:block hidden">
                                    <div className="relative flex">
                                        <img className="rotate-180" src="/image/comma.png" alt="" />
                                        <img className="absolute right-12 rotate-180" src="/image/comma.png" alt="" />
                                    </div>
                                </div>
