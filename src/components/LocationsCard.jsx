            ...
            className="flex flex-wrap justify-center gap-x-8 items-center md:gap-y-20 gap-y-8 3xl:pr-[90px] mt-6">
            {
                arrayData.map((el, i) => (
                    <Link key={uuid4()} to={el.link}>
                        <m.div variants={el.variant} className="3xl:w-[830px] md:w-[660px] w-[380px] relative group cursor-pointer">
                            <img className="absolute 3xl:h-auto md:h-[260px] h-[170px] left-0 bottom-0" src={el.img} alt="" />
